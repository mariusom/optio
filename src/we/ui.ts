...
export const topBar = <M>(
  ...
  h.header(
    ...
    [
      h.div(
        [h.Class("mx-auto flex h-12 w-full max-w-3xl items-center justify-between px-4")],
        [
          h.div([h.Class("min-w-16")], []),
          h.h1(
            [
              h.Class(
                "max-w-[220px] truncate text-center text-base font-semibold tracking-tight sm:max-w-xs",
              ),
            ],
            [title],
          ),
          h.div(
            [h.Class("flex min-w-16 items-center justify-end")],
